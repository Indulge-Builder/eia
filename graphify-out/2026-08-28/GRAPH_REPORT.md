...
## Corpus Check
- 1007 files · ~5,698,400 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7865 nodes · 15839 edges · 456 communities (425 shown, 31 thin omitted)
...
Cohesion: 0.17
Nodes (17): encoder, isRateLimited, POST(), SseEvent, resolveStaffPrincipal(), isRateLimited, LEAD_SOURCES_SET, logRawPayload() (+9 more)

### Community 3 - "Auth & Lead Actions"
Cohesion: 0.04
Nodes (89): addTaskRemarkAction(), DealCategory, DealDuration, isNotificationCategoryKey(), DASHBOARD_PIPELINE_ROLES, REDIS_KEYS, REDIS_TTL, SIA_ALERT_KINDS (+81 more)

### Community 4 - "Task Constants & UI"
Cohesion: 0.08
Nodes (25): AdSpendUploadModal(), Props, CardBody(), cardStyle, DealCard(), DealCardProps, useWonCelebration(), DealsAsyncProps (+17 more)

### Community 5 - "Task Actions & Mutations"
Cohesion: 0.05
Nodes (46): getAgentTasksSummaryAction(), AgentSelfMetrics, getAgentPulseAction(), DealsSummaryStripProps, useDashboardCohortSync(), useWidgetData(), UseWidgetDataOptions, WidgetFetcher (+38 more)
...
Cohesion: 0.10
Nodes (25): REVIVAL_CANDIDATE_STATUSES, REVIVAL_DEFAULT_SILENCE_DAYS, REVIVAL_TASK_PRIORITY, REVIVAL_TASK_TYPE, REVIVAL_VERDICTS, RevivalTriggerStatus, getLeadNotes(), maskPii() (+17 more)

### Community 8 - "Dashboard Widget Registry"
Cohesion: 0.08
Nodes (33): AgentDetailAsync(), AppDomainCallerRole, TeamDetailAsync(), describeMeta(), EVENT_META, OversightAgentRail(), OversightTeamRail(), RailRow() (+25 more)

### Community 9 - "Auth Roles & Cache Actions"
Cohesion: 0.12
Nodes (33): CustomerTurnInput, resolveCustomerPrincipal(), handleCustomerReply(), maybeSendCustomerWelcome(), mediaTypeForKind(), recordBotMessage(), resolveInboundText(), sendTurnMedia() (+25 more)

### Community 10 - "WhatsApp Constants & Config"
Cohesion: 0.06
Nodes (44): createLeadTaskAction(), exportLeadsAction(), EMPTY, PaletteDealHit, PaletteLeadHit, PaletteTaskHit, deleteGroupTaskAction(), initiateWhatsAppConversationAction() (+36 more)
...
Cohesion: 0.15
Nodes (19): DateRangePreset, DEF, matchDateRangePreset(), mondayOf(), resolveDateRangePreset(), serialize(), shiftDays(), CampaignDetailPage() (+11 more)

### Community 16 - "Ad Creative UI Components"
Cohesion: 0.04
Nodes (72): ROW_VARIANTS, GROUP_TASK_ACCENT_COLORS, GROUP_TASK_ICONS, TASK_CATEGORY, TASK_PRIORITY, TASK_REMARK_STATUS_LABELS, TASK_STATUS, TASK_STATUS_DEF (+64 more)
...
Cohesion: 0.03
Nodes (111): ADMIN_ROLES, deleteAdCreative(), upsertAdCreative(), ADMIN_ROLES, uploadAdSpendAction(), UploadAdSpendSummary, setAgentShiftAction(), toggleRoutingSchema (+103 more)
...
Cohesion: 0.12
Nodes (27): dismissRevivalCandidateAction(), reviveLeadAction(), updateRevivalPolicyAction(), REVIVAL_TRIGGER_STATUSES, RevivalDossierAction(), ReviveLeadButton(), ReviveLeadButtonProps, createLeadTaskCore() (+19 more)
...
Cohesion: 0.14
Nodes (22): getMyNotificationsAction(), markAllReadAction(), markNotificationReadAction(), markReadSchema, SPRING_BOUNCE, useNotifications(), UseNotificationsReturn, useNotificationSound() (+14 more)
...
Cohesion: 0.07
Nodes (48): useCreateTriggerModal(), getGroupTasks, GiaTask, PersonalTasksResult, TaskGroupRow, AssigneePickerModal(), AssigneePickerModalProps, ROLE_BADGE_COLORS (+40 more)
...
Cohesion: 0.09
Nodes (25): DEAL_CATEGORY_DEF, DEAL_DURATION_DEF, DEAL_TYPE_DEF, DealShape, DealShapeInput, DealType, dealTypeForDomain(), DomainDealConfig (+17 more)
...
Cohesion: 0.16
Nodes (24): ELAYA_DAILY_LINES, getElayaTimeGreeting(), pickElayaDailyLine(), metadata, MobileElayaPage(), ElayaChatScreen(), countUserMessagesToday(), ElayaSeedMessage (+16 more)
...
Cohesion: 0.13
Nodes (24): CreateLeadTaskModalProps, LeadTasksCardProps, TaskAssigneeContext, TaskGiaContext, CreateGroupTaskModal(), GroupTaskWithMeta, INPUT_BASE, SubtaskDraft (+16 more)

### Community 42 - "Agent Deals & Cards"
Cohesion: 0.11
Nodes (28): UsersTable(), CallerRole, OversightAgentPage(), CampaignFilters(), CampaignListSkeleton(), CampaignsPage(), parseFilters(), isAppDomain() (+20 more)

### Community 43 - "Lead Sources & Activity"
Cohesion: 0.08
Nodes (18): SUBSCRIPTION_STATUS_CONFIG, Props, CurrencyAmount(), DepartmentPills(), DEPT_PILL, PILL_BASE, SubscriptionStatusPill(), TypePill() (+10 more)
...
Cohesion: 0.07
Nodes (23): getServiceCategoryLabel(), SERVICE_CATEGORY_DEF, ServiceCategory, ServiceInterest, AddSuggestionModal(), AddSuggestionModalProps, borderFor(), fieldChrome (+15 more)

### Community 46 - "Dashboard Widget Data Hooks"
Cohesion: 0.09
Nodes (33): CampaignFiltersProps, ALL_DOMAINS_ICON, GIA_DOMAIN_FILTER_ITEMS, parseGiaDomainParam(), persistDomainCookie(), readDomainCookie(), SUBSCRIPTION_DEPARTMENT_OPTIONS, SUBSCRIPTION_STATUS_OPTIONS (+25 more)
...
Cohesion: 0.08
Nodes (28): PaletteSearchResult, JOURNEY_STATUSES, LEAD_STATUS_BADGE, LEAD_STATUS_COLORS, LEAD_STATUS_LABELS, RESOLUTION_STATUSES, Props, RevivalReviewBanner() (+20 more)
...
Cohesion: 0.17
Nodes (19): addDaysISO(), cardStyle, dueRow, pad2(), resetBtn, SubOccurrence, SubscriptionHistoryModal, SubscriptionPaymentRow (+11 more)
...
Cohesion: 0.11
Nodes (19): WorkspaceAsync(), WorkspaceAsyncProps, CompletedTaskCursor, CompletedTaskRaw, CompletedTaskRow, CompletedTasksResult, DomainTaskAgentSummary, DomainTaskSummaryRpcRow (+11 more)
...
Cohesion: 0.06
Nodes (71): DomainsVolumeSchema, effectiveWidgetDomain(), GaugeScopeSchema, getAgentRecentActivityAction(), getBudgetGaugeWidgetAction(), getLeadsByCampaignAction(), getLeadStatusSummaryAction(), getLeadVolumeByDomainsAction() (+63 more)

### Community 61 - "Elaya Principal & Tools"
Cohesion: 0.08
Nodes (27): CardHeader(), Props, LeadActivitiesAsync(), Props, formatTimestamp(), LeadActivityLog(), Props, buildStatusTimestamps() (+19 more)
...
Cohesion: 0.09
Nodes (33): SPRING_CONFIG, ElayaStatusText(), SiaGroupKind, SiaGroupRow, SiaMessageRow, SiaSearchHit, groupTitle(), KIND_LABEL (+25 more)
...
Cohesion: 0.06
Nodes (30): compareDomainDisplayOrder(), categoriesForRole(), CATEGORY_BY_KEY, NOTIFICATION_CATEGORY_ENUM, NOTIFICATION_CATEGORY_KEYS, NotificationCategory, NotificationCategoryKey, NotificationChannel (+22 more)
...
Cohesion: 0.09
Nodes (40): getSiaGroupInfoAction(), getSiaGroupsAction(), getSiaHealthAction(), getSiaMediaAction(), getSiaMessagesAction(), GROUP_KINDS, isGroupJid(), isIsoTimestamp() (+32 more)
...
Cohesion: 0.08
Nodes (30): AccountReportSection(), BudgetTab, BudgetTabContext, BudgetTabContextValue, BudgetTabProvider(), useBudgetTab(), BudgetFilterBar(), TABS (+22 more)
...
Cohesion: 0.07
Nodes (43): WIDGET_MAP, DROPDOWN_VARIANTS, DROPDOWN_VARIANTS_UP, EASE_IN_OUT, EASE_SPRING, FADE_VARIANTS, FLIP_UP_TRANSFORM_TEMPLATE(), AddWidgetMenu() (+35 more)

### Community 82 - "Lead Column Preferences"
Cohesion: 0.20
Nodes (11): AppearanceKey, applyAppearanceToDom(), DEF, persistAppearanceCookie(), resolvesDark(), systemPrefersDark(), CALL_OUTCOME_DEF, defineEnum() (+3 more)

### Community 83 - "Error Log Table"
Cohesion: 0.07
Nodes (40): anthropicAdapter, collectMedia(), CustomerTurnMedia, CustomerTurnResult, runCustomerTurn(), buildCustomerSystemPrompt(), CustomerPrincipal, LlmChatMessage (+32 more)
...
Cohesion: 0.07
Nodes (50): getDomainHealthMetricsAction(), getManagerRosterAction(), getAgentPulse(), getRoster(), ManagerPerformanceAsync(), Props, AgentPerformanceAsync(), PerformancePage() (+42 more)
...
Cohesion: 0.06
Nodes (44): BarChartSeries, clampWidgetHeight(), DASHBOARD_WIDGETS, DEFAULT_GRID_BY_ROLE, DEFAULT_LAYOUT_BY_ROLE, DENSITY_THRESHOLDS, GridPlacement, isValidWidgetId() (+36 more)
...
Cohesion: 0.10
Nodes (11): DEMO_CONCIERGE, DEMO_THREAD, FIELD_CHROME, MobileTextArea(), SearchPill(), ActionSheetItem, MobileActionSheet(), SOFT_OUT (+3 more)
...
Cohesion: 0.07
Nodes (31): chevronStyle, filterSelectStyle, getRolePillStyle(), UserCard(), UsersTableProps, BudgetEmptyState(), APP_DOMAINS, DOMAIN_LABELS (+23 more)
...
Cohesion: 0.07
Nodes (50): addLeadNote(), assertLeadFieldEditAccess(), assignLead(), bulkUpdateLeads(), BulkUpdateResult, createManualLead(), ExportPayload, LeadEditContext (+42 more)
...
Cohesion: 0.29
Nodes (7): CampaignMetricsStripSkeleton(), CampaignMetricsAsync(), LeadsPagination(), LeadsPaginationProps, getCampaignAgentDistribution(), getCampaignDetailMetrics(), CampaignDetailMetrics
...
Cohesion: 0.12
Nodes (17): AudioRecorderStatus, AudioRecording, formatRecorderElapsed(), MIME_CANDIDATES, useAudioRecorder(), UseAudioRecorderOptions, AppBootScreen(), LeadNotesInput() (+9 more)
...
Cohesion: 0.19
Nodes (11): loginSchema, RequireProfileResult, updatePasswordAction(), ForgotPasswordInput, forgotPasswordSchema, LoginInput, loginSchema, UpdatePasswordInput (+3 more)
...
Cohesion: 0.18
Nodes (9): Props, Props, Props, DomainDrillKind, DomainLeadsDrillModal(), KIND_LABEL, Props, LeadDrillModal() (+1 more)
...
Cohesion: 0.15
Nodes (17): ACTIVITY_EXPORT_HEADERS, ExportHeader, LEAD_EXPORT_HEADERS, NOTE_EXPORT_HEADERS, LeadExportItem, currentMonthIso(), FORMAT_TABS, REPORT_HEADERS (+9 more)

### Community 134 - "Community 134"
Cohesion: 0.10
Nodes (24): ELAYA_STARTER_PROMPTS, ElayaSseEvent, ElayaStreamHandlers, streamElayaChat(), TOOL_STATUS_LABELS, toolStatusLabel(), Props, CAPABILITIES (+16 more)
...
Cohesion: 0.10
Nodes (30): CURRENCY_SYMBOLS, INVOICE_ACCEPT_MIME, PAYMENT_TYPES, SUBSCRIPTION_CURRENCY_DEF, SUBSCRIPTION_STATUSES, SUBSCRIPTION_TYPE_DEF, SubscriptionCurrency, SubscriptionShape (+22 more)
...
Cohesion: 0.05
Nodes (62): paletteSearchAction(), getPersonalTasksAction(), findOwnersInDomain(), findTeammates(), getBudget(), getCampaigns(), getColdLeads(), getDomainHealth() (+54 more)
...
Cohesion: 0.04
Nodes (63): getElayaChatSeedAction(), AdCreativeFormModal(), chevronStyle, inputBase, selectBase, actionBtnStyle, AdCreativesManager(), CARD_HOVER (+55 more)
...
Cohesion: 0.16
Nodes (14): LeadRevivalPage(), metadata, getAllRevivalPolicies(), AgentSettingsTable(), metadata, SettingsPage(), inputStyle, RevivalPoliciesPanel() (+6 more)
...
Cohesion: 0.19
Nodes (15): generateMetadata(), generateViewport(), inter, playfairDisplay, RootLayout(), buildManifest(), manifest(), DEF (+7 more)
...
Cohesion: 0.05
Nodes (46): toggleAgentRouting(), signOutUser(), toggleUserActive(), chevronStyle, EditAuthorizationForm(), initialState, labelStyle, Props (+38 more)
...
Cohesion: 0.07
Nodes (46): actorFromProfile(), assertAssigneeActive(), createGroupTaskAction(), createPersonalTaskAction(), createSubtaskAction(), deleteTaskAction(), getCompletedTasksAction(), getGroupSubtasksAction() (+38 more)
...
Cohesion: 0.19
Nodes (12): DEF, isThemeKey(), persistThemeCookie(), ThemeKey, DashboardLayout(), ElayaWidget(), Props, ThemeInitializer() (+4 more)
...
Cohesion: 0.10
Nodes (27): getConversationsAction(), getMessagesAction(), searchConversationsAction(), isWhatsAppPeriod(), WHATSAPP_PERIOD_LABELS, WHATSAPP_PERIODS, WhatsAppPeriod, NoteCard() (+19 more)
...
Cohesion: 0.10
Nodes (23): ADMIN_NAV, ANALYTICS_NAV, getConfigurationNav(), MAIN_NAV, MOBILE_TRIGGER_PATHS, NavItem, NavLink(), Sidebar() (+15 more)
...
Cohesion: 0.04
Nodes (87): addLeadCallNote(), armCadenceForOutcome(), ArmCadenceSchema, CadenceLeadRow, CancelSlaSchema, cancelSlaTimersForLead(), cancelSlaTimersForLeadInternal(), describePolicy() (+79 more)
...
Cohesion: 0.11
Nodes (14): JUNK_REASONS, LOST_REASONS, RESOLUTION_REASON_LABELS, CalledModal(), OUTCOME_ITEMS, Props, ActiveModal, ButtonVariant (+6 more)

### Community 262 - "Community 262"
Cohesion: 0.07
Nodes (33): AddRechargeButton(), AddRechargeModal, AdSpendUploadButton(), AdSpendUploadModal, BudgetPage(), SearchParams, useMountOnFirstOpen(), AddSuggestionButton() (+25 more)
...
Cohesion: 0.06
Nodes (35): FIRST_TOUCH_BUCKETS, FirstTouchBucket, FirstTouchBucketId, AgentCallsDrillModal(), AgentDetailPanel(), CallOutcomeBar, DetailSlice, detailSliceCache (+27 more)
...
Cohesion: 0.07
Nodes (44): ConversationIdSchema, markConversationAsRead(), SendMessageSchema, sendWhatsAppMediaMessage(), sendWhatsAppMessage(), signWhatsAppMediaAction(), resolveOutboundMediaType(), WHATSAPP_API_BASE (+36 more)
...
Cohesion: 0.11
Nodes (22): ExportButton(), ExportButtonProps, ExportModal(), BulkEditLeadsModal, LeadsSelectionToolbar(), LeadsSelectionToolbarProps, _add(), _create() (+14 more)
...
Cohesion: 0.10
Nodes (15): DOMAIN_ICONS, GIA_DOMAIN_ICONS, DOMAIN_ICONS, GIA_DOMAIN_ENUM, ADMIN_ROOMS, DOMAIN_PASTEL_TOKENS, DOMAIN_VERTICALS, DomainVertical (+7 more)

### Community 361 - "Community 361"
Cohesion: 0.07
Nodes (29): ChartSkeleton(), ChartSkeletonProps, SPRING_TAB, BenchmarkLine, CardConfig, computeDelta(), CoreFourGrid(), formatPct() (+21 more)
...
Cohesion: 0.33
Nodes (3): metadata, UpdatePasswordPage(), UpdatePasswordForm()
...
## Knowledge Gaps
- **4253 isolated node(s):** `cmd`, `@supabase/mcp-server-supabase`, `npx`, `@supabase/mcp-server-supabase`, `SUPABASE_ACCESS_TOKEN` (+4248 more)
...
- **Why does `createAdminClient()` connect `Agent Performance Shell` to `Lead Mutations & Notifications`, `Community 259`, `Auth & Lead Actions`, `Ad Spend & Campaign Mapping`, `Dashboard Widget Registry`, `Auth Roles & Cache Actions`, `WhatsApp Constants & Config`, `Lead Edit & Search`, `Budget & Spend UI`, `Task Summary & SLA Policies`, `Community 151`, `Community 160`, `Deal Type Definitions`, `Agent Detail & Performance`, `Community 294`, `Agent Deals & Cards`, `Community 176`, `Community 177`, `Motion & Date Utilities`, `Escalations & SLA Service`, `Performance Scorecards & Drills`, `Community 66`, `Community 67`, `Community 70`, `Community 206`, `Community 210`, `Error Log Table`, `Ad Creatives & Campaign Pages`, `Themes & Notifications`, `Community 365`, `Community 110`, `Tasks Page Docs`, `Profiles Data Model`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `parse()` connect `Page Skeletons & Flags` to `Community 258`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `AppDomain` connect `Chart Components` to `Call Outcome Charts`, `SLA Business Hours`, `Task Constants & UI`, `Task Actions & Mutations`, `Community 262`, `Auth & Lead Actions`, `Dashboard Widget Registry`, `Community 259`, `WhatsApp Constants & Config`, `Auth Roles & Cache Actions`, `Lead Edit & Search`, `Ad Creative UI Components`, `Budget & Spend UI`, `Task Summary & SLA Policies`, `Agent Performance Metrics`, `Community 276`, `Community 147`, `Community 151`, `Settings Page Documentation`, `Community 160`, `Deal Type Definitions`, `Audio Recorder & Notes`, `Community 291`, `Elaya Actions Service`, `Ad Creatives Page Docs`, `Agent Deals & Cards`, `Lead Sources & Activity`, `Deals Page Documentation`, `Dashboard Widget Data Hooks`, `Community 304`, `Upload & Add Modals`, `Community 176`, `Escalations & SLA Service`, `Performance Scorecards & Drills`, `Elaya Principal & Tools`, `Community 66`, `Community 68`, `Community 206`, `Notification Bell & Hooks`, `Ad Creatives & Campaign Pages`, `PII Masking & Revival Tests`, `Community 360`, `Community 232`, `Community 361`, `Community 107`, `Community 110`, `Profiles Data Model`, `Community 375`, `Community 123`?**
...
- **What connects `BM25 ranking algorithm for text search`, `Lowercase, split, remove punctuation, filter short words`, `Build BM25 index from documents` to the rest of the system?**
  _4294 weakly-connected nodes found - possible documentation gaps or missing edges._
