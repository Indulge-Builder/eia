# Graph Report - serene  (2026-08-27)

## Corpus Check
- 15639 files · ~5,707,677 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7822 nodes · 15773 edges · 457 communities (426 shown, 31 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 63 edges (avg confidence: 0.75)
...
Cohesion: 0.18
Nodes (16): isRateLimited, LEAD_SOURCES_SET, logRawPayload(), POST(), sanitizeRawPayload(), verifyMetaSignature(), JsonValue, createRateLimiter() (+8 more)

### Community 3 - "Auth & Lead Actions"
Cohesion: 0.04
Nodes (80): createWalkInDeal(), notifyDealCreated(), recordDeal(), recordDeal(), updateLeadStatus(), DEAL_CATEGORY_DEF, DEAL_DURATION_DEF, DEAL_TYPE_DEF (+72 more)
...
Cohesion: 0.05
Nodes (52): BarChart(), BarChartSeries, WIDGET_HEIGHT_BY_SIZE, DashboardWidgetSlot(), DashboardWidgetSlotProps, WIDGET_COMPONENTS, WidgetProps, useDashboardCohortSync() (+44 more)
...
Cohesion: 0.06
Nodes (39): REVIVAL_CANDIDATE_STATUSES, REVIVAL_DEFAULT_SILENCE_DAYS, REVIVAL_TASK_PRIORITY, REVIVAL_TASK_TYPE, REVIVAL_TRIGGER_STATUSES, REVIVAL_VERDICTS, RevivalTriggerStatus, getLeadNotes() (+31 more)
...
Cohesion: 0.07
Nodes (63): assignLead(), bulkUpdateLeads(), createManualLead(), upsertDomainTargetAction(), CAMPAIGN_DOMAIN_MAP, resolveDomainFromCampaign(), isNotificationCategoryKey(), selectAdapter() (+55 more)

### Community 10 - "WhatsApp Constants & Config"
Cohesion: 0.05
Nodes (69): setAgentShiftAction(), toggleAgentRouting(), toggleRoutingSchema, requireProfile(), deleteNote(), upsertNote(), deleteTrainingAsset(), TRAINING_ROLES (+61 more)
...
Cohesion: 0.13
Nodes (16): CreateLeadTaskModalProps, LeadTasksAsync(), Props, CreateLeadTaskModal, LeadTasksCard(), LeadTasksCardProps, TERMINAL, TaskAssigneeContext (+8 more)

### Community 13 - "Page Skeletons & Flags"
Cohesion: 0.10
Nodes (18): DROPDOWN_VARIANTS_UP, FLIP_UP_TRANSFORM_TEMPLATE(), loadCsv(), DatePickerProps, DEFAULT_STATE, displayLabel(), HOURS, Meridiem (+10 more)
...
Cohesion: 0.13
Nodes (22): DASHBOARD_WIDGETS, DateRangePreset, DEF, matchDateRangePreset(), mondayOf(), resolveDateRangePreset(), serialize(), shiftDays() (+14 more)

### Community 16 - "Ad Creative UI Components"
Cohesion: 0.05
Nodes (53): ROW_VARIANTS, TASK_PRIORITY, TASK_STATUS, TASK_STATUS_DEF, TASK_TYPE_DEF, useTaskCompletionToggle(), ACTIVE, AgentTaskList() (+45 more)
...
Cohesion: 0.06
Nodes (41): ADMIN_ROLES, deleteAdCreative(), upsertAdCreative(), ADMIN_ROLES, uploadAdSpendAction(), UploadAdSpendSummary, updateElayaPersonaAction(), updatePersonalDetails() (+33 more)

### Community 19 - "Agent Performance Metrics"
Cohesion: 0.08
Nodes (28): getSpendingOverview(), getSubscriptionMonthlyReport(), getSubscriptions(), groupBy(), lastTwelveMonths(), MONTH_NAMES, monthBounds(), MonthlyReportRow (+20 more)
...
Cohesion: 0.10
Nodes (16): LeadDossierPage(), DynamicFormResponses(), Props, LeadDealCard(), LeadDealCardProps, LeadDealCardAsync(), Props, LeadTasksCardSkeleton() (+8 more)
...
Cohesion: 0.11
Nodes (21): getTypeIcon(), getTypeIconColor(), NotificationItem(), Avatar(), AVATAR_COLOUR_PAIRS, AvatarProps, AvatarSize, FONT_SIZE (+13 more)

### Community 30 - "Settings Page Documentation"
Cohesion: 0.20
Nodes (17): PersonalTaskRow, AssigneePickerModal(), CreatePersonalTaskModal(), buildTaskDots(), CalendarTaskRow, CalendarTaskRowProps, DateSection, getDueDateColor() (+9 more)
...
Cohesion: 0.16
Nodes (21): useCreateTriggerModal(), GroupTasksTab(), MyTasksCalendarView(), Tab, TasksFilters(), TasksFiltersProps, TasksShell(), TaskType (+13 more)
...
Cohesion: 0.08
Nodes (32): getAgentDealsScopedAction(), AdSpendUploadModal(), Props, CampaignListAsyncProps, DealType, MODAL_VARIANTS, CardBody(), formatTimestamp() (+24 more)
...
Cohesion: 0.08
Nodes (52): config, CONNECTOR_DIR, env, fileEnv, HERE, REPO_ROOT, db, insertMediaRow() (+44 more)
...
Cohesion: 0.07
Nodes (36): CampaignCard(), CampaignCardProps, DOT_COLOR, MotionLink, StatusDatum(), StatusTone, CampaignMetricsStrip(), CampaignMetricsStripProps (+28 more)

### Community 41 - "Ad Creatives Page Docs"
Cohesion: 0.06
Nodes (43): GROUP_TASK_ACCENT_COLORS, GROUP_TASK_ICONS, TASK_CATEGORY, TASK_REMARK_STATUS_LABELS, AddSuggestionModal(), AddSuggestionModalProps, borderFor(), fieldChrome (+35 more)

### Community 42 - "Agent Deals & Cards"
Cohesion: 0.13
Nodes (24): CampaignListSkeleton(), CampaignsPage(), parseFilters(), ElayaPage(), EscalationsPage(), metadata, HelpdeskPage(), Props (+16 more)

### Community 43 - "Lead Sources & Activity"
Cohesion: 0.06
Nodes (32): SUBSCRIPTION_STATUS_CONFIG, SubscriptionCurrency, Props, CurrencyAmount(), DepartmentPills(), DEPT_PILL, PILL_BASE, SubscriptionStatusPill() (+24 more)

### Community 44 - "App Layout & Manifest"
Cohesion: 0.09
Nodes (25): AdCreativesPage(), EMPTY_FILTERS, AdCreativesManager(), CampaignListAsync(), ROUTING_POOL_ROLES, LeadNotesSection(), OUTCOME_BADGE, Props (+17 more)

### Community 45 - "Deals Page Documentation"
Cohesion: 0.10
Nodes (31): getPersonalTasksAction(), findOwnersInDomain(), findTeammates(), getBudget(), getCampaigns(), getColdLeads(), getDomainHealth(), getEscalations() (+23 more)

### Community 46 - "Dashboard Widget Data Hooks"
Cohesion: 0.11
Nodes (25): CampaignFilters(), CampaignFiltersProps, GIA_DOMAIN_FILTER_ITEMS, PAYMENT_TYPES, SUBSCRIPTION_CURRENCY_DEF, SUBSCRIPTION_DEPARTMENT_OPTIONS, SUBSCRIPTION_STATUS_OPTIONS, SUBSCRIPTION_STATUSES (+17 more)
...
Cohesion: 0.06
Nodes (39): CALL_OUTCOME_DEF, JOURNEY_STATUSES, LEAD_STATUS_COLORS, LEAD_STATUS_LABELS, LEAD_STATUSES, RESOLUTION_STATUSES, LeadsFiltersProps, OUTCOME_ITEMS (+31 more)

### Community 50 - "Motion & Date Utilities"
Cohesion: 0.13
Nodes (21): actionBtnStyle, AssetCard(), CARD_HOVER, ElayaTrainingManager(), ElayaTrainingManagerProps, KIND_ICON, safeHost(), chevronStyle (+13 more)
...
Cohesion: 0.07
Nodes (48): ALWAYS_ALLOWED_PREFIXES, DOMAIN_ROUTE_MAP, AddDealButton(), NewDealModal, Props, WorkspaceAsync(), WorkspaceAsyncProps, CompletedTaskCursor (+40 more)

### Community 58 - "Anthropic LLM Adapter"
Cohesion: 0.07
Nodes (28): LeadWithAssignee, ALL_TOOLS, ElayaReadToolName, ElayaTool, ElayaToolExecution, findTeammate, FOUNDER_UP, getBudget (+20 more)
...
Cohesion: 0.08
Nodes (26): CardHeader(), Props, LeadActivitiesAsync(), Props, LeadActivityLog(), Props, buildStatusTimestamps(), CORE_STAGES (+18 more)
...
Cohesion: 0.05
Nodes (33): getDomainInterests(), getLeadSourceLabel(), getMetaMediumLabel(), LEAD_SOURCE_DEF, LeadSource, META_MEDIUM_LABELS, PLATFORM_LABELS, cardStyle (+25 more)

### Community 65 - "Community 65"
Cohesion: 0.10
Nodes (25): PaletteSearchResult, EASE_IN_OUT, SPRING_CONFIG, useDebounce(), SiaMessageRow, groupTitle(), senderInk(), senderLabel() (+17 more)
...
Cohesion: 0.16
Nodes (13): SUGGESTION_CATEGORY_DEF, SUGGESTION_STATUS_DEF, SuggestionCategory, SuggestionStatus, CreateSuggestionPayload, signPaths(), SuggestionInboxRow, Attachment (+5 more)
...
Cohesion: 0.08
Nodes (50): getSiaGroupInfoAction(), getSiaGroupsAction(), getSiaHealthAction(), getSiaMessagesAction(), GROUP_KINDS, isGroupJid(), isIsoTimestamp(), searchSiaMessagesAction() (+42 more)
...
Cohesion: 0.07
Nodes (42): AccountReportSection(), AddRechargeModal(), fieldLabelStyle, inputStyle, Props, todayIso(), useBudgetTab(), Props (+34 more)
...
Cohesion: 0.08
Nodes (22): BudgetTab, BudgetTabContext, BudgetTabContextValue, BudgetTabProvider(), BudgetFilterBar(), TABS, FounderPerfActionsContext, FounderPerfActionsContextValue (+14 more)
...
Cohesion: 0.16
Nodes (17): EASE_SPRING, MQ, useMediaQuery(), NotificationPanel(), PANEL_VARIANTS, CompletedTasksButton(), CompletedTasksModal, DateRangeFields() (+9 more)
...
Cohesion: 0.04
Nodes (97): ActivityCursorSchema, AgentSelfMetrics, assertDrillAccess(), DOMAIN_LEADS_DRILL_KINDS, DomainLeadsDrillKind, DrillCursorSchema, FIRST_TOUCH_BUCKET_IDS, getAgentCallsForManagerAction() (+89 more)
...
Cohesion: 0.09
Nodes (35): clampWidgetHeight(), DEFAULT_GRID_BY_ROLE, DEFAULT_LAYOUT_BY_ROLE, DENSITY_THRESHOLDS, GridPlacement, isValidWidgetId(), MANAGER_GRID, resolveWidgetDensity() (+27 more)
...
Cohesion: 0.18
Nodes (12): metadata, MobileActivityPage(), ActivityRoom(), EVENT_PRESENTATION, eventDetail(), FeedState, statusWord(), ActivityFeedCursor (+4 more)
...
Cohesion: 0.10
Nodes (18): chevronStyle, filterSelectStyle, getRolePillStyle(), UserCard(), UsersTable(), UsersTableProps, APP_DOMAINS, useFounderPerfActions() (+10 more)
...
Cohesion: 0.06
Nodes (46): addLeadNote(), assertLeadFieldEditAccess(), BulkUpdateResult, createLeadTaskAction(), exportLeadsAction(), ExportPayload, LeadEditContext, revalidateLeadDossier() (+38 more)
...
Cohesion: 0.12
Nodes (19): CampaignMetricsStripSkeleton(), LEAD_STATUS_BADGE, DealsAsyncProps, CampaignLeadsAsync(), CampaignMetricsAsync(), LeadsPagination(), LeadsPaginationProps, LeadsTableAsync() (+11 more)

### Community 117 - "Task Flow Sequences"
Cohesion: 0.14
Nodes (16): AddRechargeButton(), AddRechargeModal, AdSpendUploadButton(), AdSpendUploadModal, BudgetPage(), SearchParams, useMountOnFirstOpen(), CommandPalette (+8 more)
...
Cohesion: 0.09
Nodes (23): AudioRecorderStatus, AudioRecording, formatRecorderElapsed(), MIME_CANDIDATES, useAudioRecorder(), UseAudioRecorderOptions, LeadNotesInput(), Props (+15 more)
...
Cohesion: 0.08
Nodes (26): metadata, MobileAgentTasksPage(), GIA_DOMAIN_ENUM, UserDetailPage(), getProfileById(), SetAgentShiftInput, SetAgentShiftSchema, CreateWalkInDealInput (+18 more)
...
Cohesion: 0.08
Nodes (36): BarChartProps, CARTESIAN_MARGIN, cartesianDefaults, ChartFrame(), ChartFrameProps, ChartTokens, FALLBACK, resolveColorMap() (+28 more)
...
Cohesion: 0.16
Nodes (6): ElayaLoading(), EscalationsSkeleton(), COL_WIDTHS, Shimmer(), SkeletonCard(), skeletonStagger()
...
Cohesion: 0.08
Nodes (26): ACTIVITY_EXPORT_HEADERS, ExportHeader, LEAD_EXPORT_HEADERS, NOTE_EXPORT_HEADERS, useLeadColumnPreferences(), ExportButton(), ExportButtonProps, BulkEditLeadsModal (+18 more)

### Community 134 - "Community 134"
Cohesion: 0.09
Nodes (30): getElayaChatSeedAction(), ELAYA_STARTER_PROMPTS, ElayaSseEvent, ElayaStreamHandlers, streamElayaChat(), TOOL_STATUS_LABELS, toolStatusLabel(), ElayaChatShell() (+22 more)
...
Cohesion: 0.10
Nodes (16): AdCreativeFormModal(), chevronStyle, inputBase, selectBase, BulkEditLeadsModalProps, fieldLabel, STATUS_ITEMS, ReviveLeadButtonProps (+8 more)
...
Cohesion: 0.16
Nodes (23): GiaDomain, DomainFetchResult, useDomainRoomData(), ProgressCard(), DomainSwiper(), BudgetRoom(), DashboardRoom(), ComingSoonCard() (+15 more)

### Community 177 - "Community 177"
Cohesion: 0.12
Nodes (19): EASE_OUT_SOFT, FollowUpEnginePage(), metadata, LeadRevivalPage(), metadata, NewUserPage(), getAgentRosterByDomain(), getAllRevivalPolicies() (+11 more)
...
Cohesion: 0.11
Nodes (17): AgentDistributionBar(), AgentDistributionBarProps, SEGMENT_COLORS, AgentDistributionRow, CompositeTypes, Constants, DatabaseWithoutInternals, DefaultSchema (+9 more)
...
Cohesion: 0.08
Nodes (24): actionBtnStyle, CARD_HOVER, EASE_IN_EXPO, EASE_OUT_EXPO, FADE_VARIANTS, FormNotice(), FormNoticeProps, TONES (+16 more)

### Community 203 - "Community 203"
Cohesion: 0.21
Nodes (14): parseGiaDomainParam(), readDomainCookie(), DealsSkeleton(), DealsPage(), parseFilters(), CondensingPageHeader(), CondensingPageHeaderProps, DomainSelector() (+6 more)
...
Cohesion: 0.11
Nodes (15): PushSupport, usePushSubscription(), UsePushSubscriptionReturn, AppearanceSelector(), IconSelector(), BeforeInstallPromptEvent, InstallPrompt(), Platform (+7 more)

### Community 206 - "Community 206"
Cohesion: 0.04
Nodes (68): listAgentsForDealDomain(), createUser(), getAssignableUsersAction(), inviteUser(), mapProfileError(), signOutUser(), toggleUserActive(), updateProfile() (+60 more)
...
Cohesion: 0.19
Nodes (11): DROPDOWN_VARIANTS, DashboardDateFilter(), DashboardDateFilterProps, PRESETS, UseUrlFiltersOptions, UseUrlFiltersReturn, DATE_PRESET_LABELS, DatePreset (+3 more)
...
Cohesion: 0.24
Nodes (13): isWhatsAppPeriod(), WHATSAPP_PERIOD_LABELS, WHATSAPP_PERIODS, WhatsAppPeriod, parseWhatsAppPeriodFromSearchParams(), WhatsAppPeriodRange, ConversationList(), ConversationListProps (+5 more)
...
Cohesion: 0.15
Nodes (11): sendWhatsAppMessage(), dateSeparatorLabel(), LeadWhatsAppCard(), LeadWhatsAppCardAsync(), Props, getConversation(), getConversationByLeadId(), getMessages() (+3 more)
...
Cohesion: 0.16
Nodes (13): ElayaFeedbackCard(), ADMIN_NAV, ANALYTICS_NAV, getConfigurationNav(), MAIN_NAV, MOBILE_TRIGGER_PATHS, NavItem, NavLink() (+5 more)
...
Cohesion: 0.21
Nodes (13): getConversationsAction(), getMessagesAction(), LeadWhatsAppCardProps, WhatsAppConversation, WhatsAppMessage, ConversationPanel(), ConversationPanelProps, groupByDate() (+5 more)
...
Cohesion: 0.05
Nodes (67): addLeadCallNote(), armCadenceForOutcome(), ArmCadenceSchema, CadenceLeadRow, CancelSlaSchema, cancelSlaTimersForLead(), cancelSlaTimersForLeadInternal(), describePolicy() (+59 more)
...
Cohesion: 0.15
Nodes (11): JUNK_REASONS, LOST_REASONS, RESOLUTION_REASON_LABELS, CalledModal(), ActiveModal, ButtonVariant, JUNK_REASON_ITEMS, LOST_REASON_ITEMS (+3 more)
...
Cohesion: 0.05
Nodes (39): FIRST_TOUCH_BUCKETS, FirstTouchBucket, FirstTouchBucketId, AgentCallsDrillModal(), AgentDealsDrillModal(), AgentDetailPanel(), CallOutcomeBar, DetailSlice (+31 more)
...
Cohesion: 0.16
Nodes (18): ConversationIdSchema, markConversationAsRead(), searchConversationsAction(), SendMessageSchema, sendWhatsAppMediaMessage(), signWhatsAppMediaAction(), resolveOutboundMediaType(), mediaExtFromMime() (+10 more)
...
Cohesion: 0.23
Nodes (11): applyLastMessagePeriodFilter(), attachUnreadCounts(), getConversations(), getUnreadCount(), searchConversations(), WaConversationRow, WaMessageRow, WhatsAppConversationListFilters (+3 more)
...
Cohesion: 0.21
Nodes (7): DOMAIN_ICONS, GIA_DOMAIN_ICONS, ALL_DOMAINS_ICON, DOMAIN_ICONS, DOMAIN_LABELS, persistDomainCookie(), DOMAIN_ITEMS
...
## Knowledge Gaps
- **4235 isolated node(s):** `cmd`, `@supabase/mcp-server-supabase`, `npx`, `@supabase/mcp-server-supabase`, `SUPABASE_ACCESS_TOKEN` (+4230 more)
...
- **Why does `createAdminClient()` connect `Auth Roles & Cache Actions` to `Lead Mutations & Notifications`, `Community 259`, `Auth & Lead Actions`, `Ad Spend & Campaign Mapping`, `Dashboard Widget Registry`, `WhatsApp Constants & Config`, `Budget & Spend UI`, `Task Summary & SLA Policies`, `Agent Performance Shell`, `Agent Detail & Performance`, `Community 294`, `Agent Deals & Cards`, `App Layout & Manifest`, `Deals Page Documentation`, `Community 174`, `Community 177`, `Escalations & SLA Service`, `Performance Scorecards & Drills`, `Community 67`, `Community 70`, `Agent Usage & Presence`, `Community 206`, `Community 210`, `Error Log Table`, `Ad Creatives & Campaign Pages`, `Themes & Notifications`, `Community 97`, `Community 110`, `Tasks Page Docs`, `Profiles Data Model`, `Zoho Lead Import V2`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `AppDomain` connect `Escalations & SLA Service` to `Call Outcome Charts`, `Auth & Lead Actions`, `Community 259`, `Task Actions & Mutations`, `Community 262`, `Community 133`, `Dashboard Widget Registry`, `Auth Roles & Cache Actions`, `WhatsApp Constants & Config`, `Ad Creative UI Components`, `Budget & Spend UI`, `Agent Performance Metrics`, `Community 276`, `Agent Performance Shell`, `Community 147`, `Community 151`, `Campaign & Domain Filters`, `Settings Page Documentation`, `Community 160`, `Deal Type Definitions`, `Audio Recorder & Notes`, `Community 291`, `Chart Components`, `Elaya Actions Service`, `Ad Creatives Page Docs`, `Agent Deals & Cards`, `Lead Sources & Activity`, `App Layout & Manifest`, `Deals Page Documentation`, `Community 300`, `Dashboard Widget Data Hooks`, `Upload & Add Modals`, `Community 180`, `Performance Scorecards & Drills`, `Elaya Principal & Tools`, `Toast & Domain Utilities`, `Community 65`, `Community 66`, `Community 203`, `Agent Usage & Presence`, `Community 206`, `Notification Bell & Hooks`, `Community 81`, `Community 210`, `Ad Creatives & Campaign Pages`, `PII Masking & Revival Tests`, `Community 97`, `Community 360`, `Community 107`, `Community 110`, `Tasks Page Docs`, `Task Flow Sequences`, `Community 123`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `formatDate()` connect `Audio Recorder & Notes` to `Call Outcome Charts`, `Community 257`, `Community 259`, `Task Constants & UI`, `Community 133`, `Task Actions & Mutations`, `Auth Roles & Cache Actions`, `Page Skeletons & Flags`, `Ad Creative UI Components`, `Agent Performance Metrics`, `SSE & Elaya Routing`, `Campaign & Domain Filters`, `Settings Page Documentation`, `Community 291`, `Lead Sources & Activity`, `App Layout & Manifest`, `Community 176`, `Task Completion & Lead Tasks`, `Escalations & SLA Service`, `Performance Scorecards & Drills`, `Elaya Principal & Tools`, `Toast & Domain Utilities`, `Community 65`, `Community 70`, `Agent Usage & Presence`, `Community 205`, `Community 236`, `Tasks Page Docs`?**
...
- **What connects `BM25 ranking algorithm for text search`, `Lowercase, split, remove punctuation, filter short words`, `Build BM25 index from documents` to the rest of the system?**
  _4276 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Changelog Entries` be split into smaller, more focused modules?**
  _Cohesion score 0.002902757619738752 - nodes in this community are weakly interconnected._
